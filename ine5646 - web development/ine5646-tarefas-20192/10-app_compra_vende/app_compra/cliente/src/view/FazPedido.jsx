...
|}
  ...
  type Acao =
    ...
    | {| type: 'ARMAZENE_ID_PEDIDO', id: string |}
...
function reducer(estado: Estado, acao: Acao): Estado {
  ...
  case 'ARMAZENE_ID_PEDIDO': {
    estado.pedido.id = acao.id.trim()
    return {...estado, pedido: estado.pedido, msg: undefined}
  }
  ...
  case 'REGISTRE_PEDIDO_ENVIADO': {
    ...
    return {...estadoInicial, pedido, msg: 'Pedido enviado!'}
  }
  ...
  return (
    <div className='card'>
      ...
      <div className='card-content'>
        ...
        <InputText 
          rotulo='Id do Pedido'
          valor={estado.pedido.id}
          onChange={(ev) => dispatch({type: 'ARMAZENE_ID_PEDIDO', id: ev.target.value})}/>
